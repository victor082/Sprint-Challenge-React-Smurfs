...
Whenever you're server side routing, you're pulling the data when you need it. This requires you to refresh the page.
When you're client side routing, you can control when you pull and use the data. 
